...
def run_import_test():
    ...
    # Get the path of this script (src/frontend/tests/test.py)
    current_file = Path(__file__).resolve()
    tests_dir = current_file.parent
    src_dir = tests_dir.parent.parent # Navigate up from src/frontend/tests to src
    rag_dir = src_dir / "RAG"

    print(f"📂 Current Dir:  {tests_dir}")
    ...
    print(f"✅ '{rag_dir}' added to sys.path")
    ...
    # Test 5: RAG Pipeline
    try:
        print("5️⃣  Importing RAGPipeline...", end=" ")
